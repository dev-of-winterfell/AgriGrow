...
class BuyerSignupPage : AppCompatActivity() {
    private lateinit var binding: ActivityBuyerSignupPageBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
       ...
       binding= ActivityBuyerSignupPageBinding.inflate(layoutInflater)
    ...
    private fun createUserDocumentInFirestore(email: String, userData: HashMap<String, String?>) {
        lifecycleScope.launch {
            try {
                ...
                Toast.makeText(this@BuyerSignupPage, "Failed to register user: ${e.message}", Toast.LENGTH_SHORT).show()
            }
        }
    }
